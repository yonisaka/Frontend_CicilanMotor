    ...
    <div class="dashboard-main-wrapper">
       ...
       <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="../index.html">Bebek Motor</a>
      ...
      <div class="nav-left-sidebar sidebar-dark">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-6" aria-controls="submenu-6"><i class="fas fa-fw fa-file"></i>Customers</a>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-7" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="#" onclick="loadMenu('<?=base_url('motor')?>')">Semua Motor</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#" onclick="loadMenu('<?=base_url('motor/form_create')?>')">Tambah Motor</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content " id="kontenTemplate">
